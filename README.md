Hola! Bienvenido a mi pequeño proyecto personal :D

MyHyprArch es un conjunto de scripts pensados para instalar Arch Linux de forma rápida y cómoda para nuevos usuarios (Y para cada vez que preparo un equipo nuevo). 
El instalador comprende la instalación de Arch, con opciones de diferentes Kernels, con algunas opciones de personalización de servicios y con Hyprland con un pequeño rice propio pensado para dar el mejor rendimiento y estabilidad posibles para cualqueir usuario
El instalador también ofrece opciones de instalar Steam, Discord y otras aplicaciones
